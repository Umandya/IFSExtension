        ...
        <div  class="container" style="background-image: url('images/gplaypattern.png'); ">
            ...
            <div class="container-fluid" style=" background-color: #863D8D; box-shadow: 0px 10px 10px #724867">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    ...
                    <form method="POST" class="navbar-form navbar-left pull-left" role="search" action="ExcelSheet">
                        
                        <button type="submit"  value="Edit" class="btn btn-default" id="getexcl">Generate Excel Sheet</button>
                ...
                <div class="col-md-8 ">
                    ...
                    <div class="col-md-6">
                            <form id="formNew" method="POST" role="search" action="AddNewEmployee">
                                <a class="btn btn-default" role="button" data-toggle-me="tooltip" title="add new user"  data-toggle="collapse" href="#collapseAddnewUser" aria-expanded="false" onclick="dropdown('collapseAddnewUser')" >
